...
export const InviteEmail = ({ siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to Combo_WICK</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            You've been invited to join <Link href={siteUrl} style={link}>Combo_WICK</Link>. Accept your invite below.
          </Text>
          <Section style={btnWrap}><Button style={button} href={confirmationUrl}>Accept Invite</Button></Section>
          <Text style={fineprint}>Not expecting this invite? You can safely ignore this email.</Text>
        </Section>
