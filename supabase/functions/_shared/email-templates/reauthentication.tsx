...
export const ReauthenticationEmail = ({ token }: ReauthenticationEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your Combo_WICK verification code</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={fineprint}>This code expires shortly. Didn't request it? Ignore this email.</Text>
        </Section>
...
const card = { background: 'linear-gradient(180deg, #faf7ff 0%, #ffffff 100%)', border: '1px solid #ece4ff', borderRadius: '12px', padding: '32px 28px', textAlign: 'center' as const }
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '32px', fontWeight: 800 as const, color: '#7c3aed', letterSpacing: '8px', margin: '8px 0 24px' }
